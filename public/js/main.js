/******/ (function (modules) {
  ...
  /******/ /******/ return __webpack_require__(
    (__webpack_require__.s = "./front.js")
  );
  /******/
})(
  /************************************************************************/
  ...
  \******************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        __webpack_require__(
          /*! bootstrap-datepicker/dist/css/bootstrap-datepicker3.standalone.css */ "./node_modules/bootstrap-datepicker/dist/css/bootstrap-datepicker3.standalone.css"
        );
        ...
        $(document).ready(function () {
          ...
          $('.block-flights-results input[type="radio"]').change(function () {
            $(this)
              .closest(".block-flights-results")
              .find(".big-blue-radio")
              .removeClass("big-blue-radio--active");
            $(this)
              .closest(".block-flights-results-list-item")
              .find(".big-blue-radio")
              .addClass("big-blue-radio--active");
          });
        });
                ...
                if (weekDay === this.o.weekStart) {
                  ...
                  if (this.o.calendarWeeks) {
                    ...
                    var // Start of current week: based on weekstart/current date
                      ws = new Date(
                        +prevMonth +
                          ((this.o.weekStart - weekDay - 7) % 7) * 864e5
                      ),
                  ...
                  if (isNaN(val)) {
                    switch (part) {
                      ...
                      case "M":
                        ...
                        val =
                          $.inArray(filtered[0], dates[language].monthsShort) +
                          1;
                        break;
                    }
                  }
